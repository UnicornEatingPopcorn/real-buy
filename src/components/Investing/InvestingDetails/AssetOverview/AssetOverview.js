...
const AssetOverview = () => {
  return (
    <div className="asset-overview__container">
      <div className="asset-overview__container-block">
        <div className="row">
          <p className="asset-overview__container-title">자산 개요</p>
        </div>
        <div className="row no-gutters asset-overview__row">
          <div className="asset-overview__row_div">
            <div className="col-12 col-sm-9 col-md-7 asset-overview__row_carousel">
              <CarouselProvider
                naturalSlideWidth={100}
                naturalSlideHeight={150}
                totalSlides={4}
                className="asset-overview__carousel"
              >
                <div>
