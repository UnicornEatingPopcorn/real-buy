  ...
  return (
    <>
      <div className="details__presentation-block">
        <div className="details__presentation-block-container">
          <div className="row no-gutters">
            <div className="col col-sm-9 col-md-6 col-lg-6">
            ...
            <div className="col col-sm-3 col-md-5 offset-md-1 col-lg-4 offset-lg-2 details__terms-col">
